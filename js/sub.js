...
$(document).ready(function () {
    var forms = $('.section_mode_subscribe form, .popup-subscribe form'),
        input = $('input[name="email"]', forms);

    var reset = function reset(that) {
        $('.form__button--result', that).remove();
    ...
    forms.on('submit', function (e) {
        e.preventDefault();
        var div = $('<div class="form__button form__button--result" />');
        var that = $(this);
        ...
        $.ajax({
            ...
            success: function success(r) {
                ...
                if (is_popup) {
                    ...
                    $('.form__button input', that).after(div);
            ...
            error: function error() {
                ...
                $('.form__button input, .popup-subscribe__row button', that).last().after(div);
            }
        });
    });
});